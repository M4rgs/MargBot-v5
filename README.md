### MargBot V5 | Auto Exploiter With 500+ Exploit 2000+ Shell | GraBBer FRom ZONE-H
...
```bash
git clone https://github.com/M4rgs/MargBot-v5.git
cd MargBot-v5
```
2. install dependencies:
```bash
pi2 install requests
pi2 install colorama
```
...
1- Env Exploit
2- SMTP CRACKER
3- Admine path finder
4- Spotify email check :P
</pre>
